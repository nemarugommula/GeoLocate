...
(function () {
  ...
  function injectButton() {
    ...
    if (controls) {
      ...
      btn.innerHTML = `<svg viewBox="0 0 64 64" width="24" height="24"><path d="M32,0C18.7,0,8,10.7,8,24c0,5.7,2.5,10.7,5.3,15l17.1,24.2c.4.5,1,.8,1.6.8s1.3-.3,1.6-.8L50.7,39C53.4,35.4,56,29.7,56,24,56,10.7,45.3,0,32,0z" fill="none" stroke="white" stroke-width="4"/><circle cx="32" cy="24" r="8" fill="none" stroke="white" stroke-width="3.5"/></svg>`;
